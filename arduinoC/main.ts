...
namespace Sentry1 {
    ...
    export function Begin(parameter: any) {
        ...
        Generator.addObject(`sentry1.Object`, "Sentry1", `sentry1(${addr});`);
        ...
        Generator.addCode(`while (SENTRY_OK != sentry1.begin(&${mode})) {yield();}`);
    }
    ...
    export function SetParamNum(parameter: any) {
        ...
        Generator.addCode(`sentry1.SetParamNum(${vision_type},(int)${num});`);
    }
    ...
    export function SetColorParam(parameter: any) {
        ...
        Generator.addCode(`sentry1.SetParam(Sentry1::kVisionColor,&param,(int)${num});`);
    }
    ...
    export function SetBlobParam(parameter: any) {
        ...
        Generator.addCode(`sentry1.SetParam(Sentry1::kVisionBlob,&param,(int)${num});`);
    }
    ...
    export function GetVisionResult(parameter: any) {
        ...
        let vision_type = parameter.VISION_TYPE.code;
        Generator.addCode([`sentry1.GetValue(${vision_type}, kStatus)`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetColorValue(parameter: any) {
        ...
        Generator.addCode([`sentry1.GetValue(Sentry1::kVisionColor,${obj},(int)${num})`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetLineValue(parameter: any) {
        ...
        Generator.addCode([`sentry1.GetValue(Sentry1::kVisionLine,${obj},(int)${num})`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetColorLable(parameter: any) {
        ...
        Generator.addCode([`sentry1.GetValue(Sentry1::kVisionColor,kLabel,(int)${num})==${obj}`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetColorBlob(parameter: any) {
        ...
        let num = parameter.NUM.code;
        let obj = parameter.COLOR_LABLE.code;
        Generator.addCode([`sentry1.GetValue(Sentry1::kVisionBlob,kLabel,(int)${num})==${obj}`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetCardLable(parameter: any) {
        ...
        Generator.addCode([`sentry1.GetValue(Sentry1::kVisionCard,kLabel,(int)${num})==${obj}`, Generator.ORDER_UNARY_POSTFIX]);
    }
    ...
    export function GetBallLable(parameter: any) {
        ...
        Generator.addCode([`sentry1.GetValue(Sentry1::kVisionBall,kLabel,(int)${num})==${obj}`, Generator.ORDER_UNARY_POSTFIX]);
    }
}
